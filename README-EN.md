...
[Türkçe ana sayfa](README.md) · [Termux installation](README-TERMUX.md) · [Build from source](BUILDING.md) · [v0.6.2 release notes](RELEASE-NOTES-v0.6.2.md)
...
See the [Turkish README](README.md) and [Termux guide](README-TERMUX.md) for full instructions.
